...
const HeroSection = () => {
    return (
        <main id='home' className=''>
            ...
            <a href="https://wa.me/923286536520" target="_blank" className='fixed bottom-7 right-7 z-100 bg-green-600 hover:bg-foreground hover:text-green-600 rounded-full p-2 transition-colors ease-linear'>
